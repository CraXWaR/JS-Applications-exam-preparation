...
describe('E2E tests', function () {
    ...
    describe('My Books Page [ 10 Points ]', async () => {
        ...
        it('the logged-in user should be able to see his/her own books (test with 2 books) [ 5 Points ]', async () => {
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it('the logged-in user should be able to see "No books in database!" (test with 0 books) [ 5 Points ]', async () => {
    ...
    describe('BONUS : Like functionality  [ 15 Points ]', async () => {
        ...
        it('Like button is not visible for guest users [ 5 Points ]', async () => {
            const data = mockData.catalog[0];
            await page.goto(host);
            await page.waitForTimeout(interval);
        ...
        it('Like button is visible for the non-creator user [ 5 Points ]', async () => {
            // Login user
        ...
        it('Like button is not visible for the creator [ 5 Points ]', async () => {
            // Login user
            const user = mockData.users[0];
            const data = mockData.catalog[0];
